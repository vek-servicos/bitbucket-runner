...
```yaml
IDE-FILE-RESOLUTION: Dependencies map to files as .bmad-infrastructure-devops/{type}/{name}, type=folder (tasks/templates/checklists/data/utils), name=file-name.
